...
Broad gym-ready exercise catalog for your app.
...
Notes:
- Includes the existing default library entries already in the app.
- Equipment is included in the `name` field in parentheses.
- This is a practical master list for a commercial gym setup. It is not every possible niche variation on earth.

## Warmup

| name | type | muscleGroup |
|---|---|---|
| High Knees (Bodyweight) | bodyweight | Warmup |
| Butt Kicks (Bodyweight) | bodyweight | Warmup |
| Arm Swings (Bodyweight) | mobility | Warmup |
| Arm Circles (Bodyweight) | mobility | Warmup |
| Hip Circles (Bodyweight) | mobility | Warmup |
| Ankle Rotations (Bodyweight) | mobility | Warmup |
| Shoulder Rotations (Bodyweight) | mobility | Warmup |
| Wrist Rotations (Bodyweight) | mobility | Warmup |
| World's Greatest Stretch (Bodyweight) | mobility | Warmup |
| Thoracic Rotations (Bodyweight) | mobility | Warmup |
| Dynamic Hamstring Sweep (Bodyweight) | mobility | Warmup |
| Walking Lunges (Bodyweight) | bodyweight | Warmup |
| Mountain Climbers (Bodyweight) | bodyweight | Warmup |
| Jumping Jacks (Bodyweight) | bodyweight | Warmup |
| Cat Cow Stretch (Bodyweight) | mobility | Warmup |

## Chest

| name | type | muscleGroup |
|---|---|---|
| Bench Press (Barbell) | weight_training | Chest |
| Bench Press (Dumbbells) | weight_training | Chest |
| Incline Bench Press (Barbell) | weight_training | Chest |
| Incline Bench Press (Dumbbells) | weight_training | Chest |
| Decline Bench Press (Barbell) | weight_training | Chest |
| Chest Press (Machine) | weight_training | Chest |
| Bench Press (Smith Machine) | weight_training | Chest |
...
| Meadows Row (Barbell) | weight_training | Upper Back |
| Seal Row (Barbell) | weight_training | Upper Back |

## Traps

| name | type | muscleGroup |
|---|---|---|
| Shrug (Barbell) | weight_training | Traps |
| Shrug (Dumbbells) | weight_training | Traps |
| Shrug (Smith Machine) | weight_training | Traps |
| Upright Row (Barbell) | weight_training | Traps |
| Face Pull (Cable) | weight_training | Traps |
| Rack Pull (Barbell) | weight_training | Traps |
| Farmer's Carry (Dumbbells) | weight_training | Traps |

## Shoulders

| name | type | muscleGroup |
|---|---|---|
| Overhead Press (Barbell) | weight_training | Shoulders |
| Shoulder Press (Dumbbells) | weight_training | Shoulders |
| Seated Shoulder Press (Dumbbells) | weight_training | Shoulders |
| Arnold Press (Dumbbells) | weight_training | Shoulders |
| Shoulder Press (Machine) | weight_training | Shoulders |
| Push Press (Barbell) | weight_training | Shoulders |
| Lateral Raise (Dumbbells) | weight_training | Shoulders |
| Lateral Raise (Cable) | weight_training | Shoulders |
...
| name | type | muscleGroup |
|---|---|---|
| Deadlift (Barbell) | weight_training | Lower Back |
| Romanian Deadlift (Barbell) | weight_training | Lower Back |
| Good Morning (Barbell) | weight_training | Lower Back |
| Back Extension (Roman Chair) | bodyweight | Lower Back |
| Reverse Hyperextension (Machine) | weight_training | Lower Back |
| Superman Hold (Bodyweight) | timed | Lower Back |

## Quads

| name | type | muscleGroup |
|---|---|---|
| Back Squat (Barbell) | weight_training | Quads |
| Front Squat (Barbell) | weight_training | Quads |
| Leg Press (Machine Plates) | weight_training | Quads |
| Hack Squat (Machine) | weight_training | Quads |
| Goblet Squat (Dumbbell) | weight_training | Quads |
| Bulgarian Split Squat (Dumbbells) | weight_training | Quads |
...
| name | type | muscleGroup |
|---|---|---|
| Hip Thrust (Barbell) | weight_training | Glutes |
| Glute Bridge (Bodyweight) | bodyweight | Glutes |
| Glute Bridge (Barbell) | weight_training | Glutes |
...
| name | type | muscleGroup |
|---|---|---|
| Adductor Machine (Machine) | weight_training | Adductors |
| Copenhagen Plank (Bench) | timed | Adductors |
| Sumo Squat (Dumbbell/Barbell) | weight_training | Adductors |
| Lateral Lunge (Dumbbells) | weight_training | Adductors |
| Cossack Squat (Bodyweight) | bodyweight | Adductors |

## Abductors

| name | type | muscleGroup |
|---|---|---|
| Hip Abduction Machine (Machine) | weight_training | Abductors |
...
| name | type | muscleGroup |
|---|---|---|
| Standing Calf Raise (Machine) | weight_training | Calves |
...
| name | type | muscleGroup |
|---|---|---|
| Deadlift (Barbell) | weight_training | Full Body |
| Clean (Barbell) | weight_training | Full Body |
| Power Clean (Barbell) | weight_training | Full Body |
| Clean and Press (Barbell) | weight_training | Full Body |
| Snatch (Barbell) | weight_training | Full Body |
| Thruster (Barbell/Dumbbells) | weight_training | Full Body |
| Burpee (Bodyweight) | bodyweight | Full Body |
| Man Maker (Dumbbells) | weight_training | Full Body |

## Cardio

| name | type | muscleGroup |
|---|---|---|
| Treadmill Walk (Treadmill) | cardio | Cardio |
| Treadmill Run (Treadmill) | cardio | Cardio |
| Incline Treadmill Walk (Treadmill) | cardio | Cardio |
| Stationary Bike (Bike) | cardio | Cardio |
| Spin Bike Sprint (Bike) | cardio | Cardio |
| Rowing Machine (Rower) | cardio | Cardio |
| Stair Climber (Machine) | cardio | Cardio |
| Elliptical (Machine) | cardio | Cardio |
| Ski Erg (Machine) | cardio | Cardio |
| Battle Ropes (Ropes) | cardio | Cardio |
| Sled Push (Sled) | cardio | Cardio |

## Sources

- ACE exercise library body-part structure: https://www.acefitness.org/resources/everyone/exercise-library/
- NASM exercise library: https://www.nasm.org/exercise-library
- Wikipedia weight training exercise list: https://en.wikipedia.org/wiki/List_of_weight_training_exercises
